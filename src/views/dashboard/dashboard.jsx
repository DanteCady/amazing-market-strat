	...
	const tileData = [
		{
			...
			description:
				'Personalized learning paths to guide your trading education.',
			actionText: 'Explore',
			icon: SchoolIcon,
			onActionClick: () => {
		...
		},
		{
			...
			description:
				'Participate in daily trading challenges to test your skills.',
			actionText: 'Join Now',
	...
	const stories = [
		{
			...
			description:
				'The stock market reached new highs today, with tech stocks leading the way.',
		},
		{
			title: 'Economic Growth Forecast',
			description:
				'Experts predict steady economic growth over the next quarter.',
		},
